...
const CreateDiscussionGroupModal = ({ isOpen, onClose, courses, onSubmit }: CreateDiscussionGroupModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/api/discussion-groups', {
        method: 'POST',
        headers: {
      ...
      toast.success('Discussion group created successfully!', {
        position: 'top-right',
        autoClose: 3000,
      ...
      // Display error toast
      toast.error('Failed to create discussion group. Please try again.', {
        position: 'top-right',
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
